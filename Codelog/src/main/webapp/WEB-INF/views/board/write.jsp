			...
			<div class="container-down">
				<div class="row py-md-3" style="margin: 5% 15% 0% 15%">
					...
					<div class="col-md-6 px-md-4" style="margin: 0 auto; width: 70%;">
						<div class="card"
							style="width: 90%; border: 0; background-color: transparent;">
							...
							<div class="thumbnailBox" id="thumbnailBox"
								style="height: 19rem; width: 100%; position: relative; background-color: rgba(128, 128, 128, 0.185); text-align: center;">
								<img src="<c:url value='/img/cat.jpg'/>" class="btn"
									...
									style="color: black; margin: 5px;">이미지를 클릭하여 썸네일을 변경하세요</span>
								<input type="file" id="thumbnailUpload" name="thumbnailUpload"
												...
												function upload() {
													...
													$
															.ajax({
																...
																success : function(
																		result) { //컨트롤러와 통신 성공 시 파일명을 반환

																	$(
																			'#thumbnail')
																			.val(
																					result); //파일명을 BoardVO에 보낼 파라미터 값에 저장
																	console
																			.log(result);
						...
						<div class="card-body my-md-2 p-0 " style="margin-bottom: 1rem">
							...
							<div class="form-floating"
								...
								<textarea placeholder="Leave a comment here"
									...
									style="width: 80%; height: 10rem; resize: none;"></textarea>
							...
							<div class="row" style="margin-top: 1rem">
								...
								<div class="btn-group my-md-0" role="group"
									...
									<button type="button" class="btn btn-outline-primary hide"
										for="btnradio3"
										style="font-size: 1.3rem; width: 2rem; border: 0">취소
									</button>
...
*/
      ...
      $(document).ready(function () {
		 ...
		 */
		 /*
		     enter 입력 시 submit이 발생하는 것을 막아주는 코드
		 */
